...
window.jwplayer = function(t) {
    ...
    function d(t) {
        ...
        var ftmediaTypes = f(t.mediaTypes || ['video/mp4;codecs="avc1.4d400d,mp4a.40.2"']);
        console.log('r='+r+'; u='+u+'; !o='+!o+'; t.mediaTypes='+t.mediaTypes+'; ftmediaTypes='+ftmediaTypes);
        alert('r='+r+'; u='+u+'; !o='+!o+'; t.mediaTypes='+t.mediaTypes+'; ftmediaTypes='+ftmediaTypes);
        u = true;
    ...
    var r = n(29),
        ...
        u = function() {
            var t = "//ssl.p.jwpcdn.com/player/v/8.17.7/";
    ...
    var r = "8.17.7+commercial_v8-17-7.431.commercial.d5a08f5.hlsjs..hlsjsprogressive.1c4e3fa.jwplayer.5f2f5b9.dai.07e1a38.freewheel.af0c077.googima.28df188.googimanvmp.106f6b4.headerbidding.3f45df0.vast.4ab78f1.analytics.c25f01b.gapro.141397a"
}, function(t, e, n) {
    "use strict";
    var r = n(0),
        i = n(18),
    ...
    function m(t, e) {
        var n = "file:" === window.location.protocol ? "https:" : "",
            r = {
                bidding: "//ssl.p.jwpcdn.com/player/v/8.17.7/bidding.js",
                jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.17.7/jwpsrv.js",
                dai: "//ssl.p.jwpcdn.com/player/plugins/dai/v/0.4.13/dai.js",
                vast: "//ssl.p.jwpcdn.com/player/plugins/vast/v/8.8.2/vast.js",
                googima: e ? "//ssl.p.jwpcdn.com/player/v/8.17.7/googimanvmp.js" : "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.8.4/googima.js",
            ...
            if (j.flashplayer = function(t) {
                    ...
                    if (n("ads")) {
                        ...
                        if (o) {
                            ...
                            u = 0 <= u.indexOf("googima.js") ? t.base + "googima.js" : t.base + "vast.js";
